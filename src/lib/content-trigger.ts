...
export async function acionarGeracaoRoteiros(mudancas: string[], userId: string): Promise<boolean> {
  try {
    ...
    const body =
      ...
      `Estrutura: Lucas = 2 longos + 2 curtos (mercado, empreendedorismo, investimento, o provedor, equilíbrio financeiro e mental); Marcela = 2 longos + 2 curtos (família, mulher, criança, acolhimento) e também mercado de trabalho. ` +
      `VOZ DA MARCELA (obrigatória em TODO roteiro/post/legenda dela; brief canônico em "D:\\FRIDAY-BRAIN\\05 - Conteúdo\\Roteiros Fundadores\\_BRIEF-Marcela-Voz-e-Identidade.md"): 1ª pessoa falando pra UMA pessoa, gancho nos 2 primeiros segundos, 1 CTA claro, e a assinatura fixa — ENTRADA "Oi, meus amores, Marcela aqui. Hoje eu quero falar de [tema]…" e SAÍDA "Os seus sonhos merecem uma chance. Um beijo no coração!". Postura acolhedora e protetora (a mulher que cuida de quem confia nela e defende contra golpe) SEM nomear esse rótulo no texto; linguagem simples e calorosa, SEM gíria escrachada ("ônibus", nunca "busão"); nunca garantia, medo ou dinheiro; sucesso só em vidas mudadas; NUNCA citar as empresas particulares dela (MN / GM Cidadania). ` +
