...
export const COUNTRIES: Country[] = [
  ...
  { code:"br", name:"Brasil", coords:[-14.24,-51.92], status:"stable", changes:2, authority:"Polícia Federal", imageUrl:"/landmarks/br.jpg", summary:"Brasil ganha tração como hub de tech latino. Visto Tech fast-track + naturalização digital criam ambiente competitivo. PF moderniza fluxos via gov.br/pf. Foco em retenção de talentos de IA e fintech.", events:[
  ...
  { code:"es", name:"Espanha", coords:[40.46,-3.74], status:"stable", changes:1, authority:"Extranjería", imageUrl:"/landmarks/es.jpg", summary:"Espanha amplia Arraigo Familiar com flexibilização de comprovação digital. Política migratória estável, com foco em reagrupamento familiar e regularização de longa data.", events:[
  ...
  { code:"fr", name:"França", coords:[46.22,2.21], status:"stable", changes:1, authority:"DGEF", imageUrl:"/landmarks/fr.jpg", summary:"França simplifica Passeport Talent via portal único online. Tempo médio de análise cai pra 60 dias. Cenário estável, com foco em atrair pesquisadores, empreendedores e profissionais de alto valor.", events:[
  ...
  { code:"dk", name:"Dinamarca", coords:[56.26,9.50], status:"stable", changes:2, authority:"SIRI", imageUrl:"/landmarks/dk.jpg", summary:"Dinamarca segue altamente seletiva mas eficiente. Positive List ampliada e Startup Denmark com limiar reduzido (€40k) — sinal claro de busca por talento qualificado em verticais estratégicas.", events:[
  ...
  { code:"pl", name:"Polônia", coords:[51.92,19.13], status:"stable", changes:2, authority:"UDSC", imageUrl:"/landmarks/pl.jpg", summary:"Polônia se posiciona como porta de entrada UE de baixo custo. Blue Card threshold competitivo + Karta Polaka acelerada — atraindo IT da Ucrânia, Belarus e tech globais.", events:[
  ...
  { code:"ie", name:"Irlanda", coords:[53.41,-8.24], status:"stable", changes:2, authority:"Irish Immigration", imageUrl:"/landmarks/ie.jpg", summary:"Irlanda mantém perfil de hub tech global. Critical Skills Permit expandido + Stamp 4 family reunification simplificado. Department of Justice processa 90% dos casos em 90 dias.", events:[
  ...
  { code:"ch", name:"Suíça", coords:[46.82,8.23], status:"stable", changes:2, authority:"SEM", imageUrl:"/landmarks/ch.jpg", summary:"Suíça expande quotas pra UE/EFTA (+12%) e non-EU (8.500 → 12.000). SEM sinaliza priorização clara: fintech, farma, hightech. Salários líquidos seguem entre os mais altos da Europa.", events:[
  ...
  { code:"at", name:"Áustria", coords:[47.52,14.55], status:"stable", changes:2, authority:"BMI", imageUrl:"/landmarks/at.jpg", summary:"Áustria mantém Red-White-Red Card como porta principal pra qualificados. Pontuação por idade/experiência/idioma. Setor tech e saúde têm via expressa via Skilled Workers in Shortage Occupations.", events:[
  ...
  { code:"be", name:"Bélgica", coords:[50.50,4.47], status:"stable", changes:1, authority:"Office des Étrangers", imageUrl:"/landmarks/be.jpg", summary:"Bélgica simplifica Single Permit pra estrangeiros não-UE. Procedimento agora 100% digital via portal único. Tempo médio cai pra 4 meses.", events:[
  ...
  { code:"bg", name:"Bulgária", coords:[42.73,25.49], status:"stable", changes:1, authority:"MVR", imageUrl:"/landmarks/bg.jpg", summary:"Bulgária amplia visto de longa permanência D pra remote workers. Schengen completo desde 2025 — atrai nômades digitais com custo de vida baixo.", events:[
  ...
  { code:"cy", name:"Chipre", coords:[35.13,33.43], status:"stable", changes:1, authority:"CRMD", imageUrl:"/landmarks/cy.jpg", summary:"Chipre mantém regime de tax-friendly residency pra non-doms. Permanent Residency via investimento imobiliário €300k+ continua ativo. Hub atrativo pra finanças e tech.", events:[
  ...
  { code:"hr", name:"Croácia", coords:[45.10,15.20], status:"stable", changes:2, authority:"MUP", imageUrl:"/landmarks/hr.jpg", summary:"Croácia consolidada no Schengen + zona Euro desde 2023. Digital Nomad Permit popular entre brasileiros. Custo de vida competitivo na UE.", events:[
  ...
  { code:"sk", name:"Eslováquia", coords:[48.67,19.70], status:"stable", changes:1, authority:"MV SR", imageUrl:"/landmarks/sk.jpg", summary:"Eslováquia mantém Single Permit padrão UE. Cenário estável, com leve abertura pra IT skilled workers via parceiros corporativos.", events:[
  ...
  { code:"si", name:"Eslovênia", coords:[46.15,14.99], status:"stable", changes:1, authority:"Govt SI", imageUrl:"/landmarks/si.jpg", summary:"Eslovênia abriu Digital Nomad Visa em jan/2025. Schengen + Euro + qualidade de vida alta. Cresce como destino discreto pra remote workers.", events:[
  ...
  { code:"ee", name:"Estônia", coords:[58.60,25.01], status:"stable", changes:2, authority:"Politsei", imageUrl:"/landmarks/ee.jpg", summary:"Estônia segue como pioneira em e-Residency e Digital Nomad Visa. Setor tech robusto, baixa burocracia. Visa decisions em até 30 dias.", events:[
  ...
  { code:"fi", name:"Finlândia", coords:[61.92,25.75], status:"stable", changes:2, authority:"Migri", imageUrl:"/landmarks/fi.jpg", summary:"Finlândia lidera Europa em qualidade de vida + sistema de imigração eficiente. Specialist Permit pra tech tem decisão em 14 dias. Migri amplia canais pra healthcare.", events:[
  ...
  { code:"gr", name:"Grécia", coords:[39.07,21.82], status:"stable", changes:2, authority:"Min Migration", imageUrl:"/landmarks/gr.jpg", summary:"Grécia mantém Golden Visa atrativo (threshold €500k em zonas premium). Digital Nomad Visa popular. Renda + clima + Schengen atraem fluxo crescente.", events:[
  ...
  { code:"nl", name:"Holanda", coords:[52.13,5.29], status:"warn", changes:2, authority:"IND", imageUrl:"/landmarks/nl.jpg", summary:"Holanda em modo de aperto: Highly Skilled Migrant salary threshold sobe pra €5.688/mês (era €5.331). DAFT (US-NL) mantido. Pressão política contra imigração líquida alta.", events:[
  ...
  { code:"hu", name:"Hungria", coords:[47.16,19.50], status:"warn", changes:2, authority:"OIF", imageUrl:"/landmarks/hu.jpg", summary:"Hungria endurece política migratória sob governo Orbán. Golden Visa relançado em 2024 com threshold €250k. Tensão constante UE × Hungria sobre regras de fronteira.", events:[
  ...
  { code:"lv", name:"Letônia", coords:[56.88,24.60], status:"stable", changes:1, authority:"PMLP", imageUrl:"/landmarks/lv.jpg", summary:"Letônia mantém Temporary Residence Permit via investimento imobiliário €250k+ ou business €50k+. Schengen + Euro + custo competitivo.", events:[
  ...
  { code:"lt", name:"Lituânia", coords:[55.17,23.88], status:"stable", changes:1, authority:"Migration Dept", imageUrl:"/landmarks/lt.jpg", summary:"Lituânia abre cada vez mais pra tech talents via Startup Visa. Programa atrai fundadores de toda Europa Oriental. Schengen + Euro + ecossistema fintech crescente.", events:[
  ...
  { code:"lu", name:"Luxemburgo", coords:[49.82,6.13], status:"stable", changes:1, authority:"Guichet.lu", imageUrl:"/landmarks/lu.jpg", summary:"Luxemburgo continua hub financeiro com regras pró-talento qualificado. Highly Qualified Worker permit em 3 meses. Centro fiscal preferido pra fundos.", events:[
  ...
  { code:"mt", name:"Malta", coords:[35.94,14.38], status:"stable", changes:2, authority:"Identità Malta", imageUrl:"/landmarks/mt.jpg", summary:"Malta mantém Malta Permanent Residence Programme (MPRP) ativo. Após reformas UE, requer combinação investimento + propriedade. Hub fintech + iGaming.", events:[
  ...
  { code:"ro", name:"Romênia", coords:[45.94,24.97], status:"stable", changes:2, authority:"IGI", imageUrl:"/landmarks/ro.jpg", summary:"Romênia entrou Schengen em mar/2024 — fluxo migratório cresceu. Digital Nomad Visa simples. Custo de vida competitivo + crescimento tech (cluster Bucareste/Cluj).", events:[
  ...
  { code:"se", name:"Suécia", coords:[60.13,18.64], status:"warn", changes:2, authority:"Migrationsverket", imageUrl:"/landmarks/se.jpg", summary:"Suécia em modo restritivo desde governo Kristersson. Work Permit salary threshold subiu pra SEK 38.500/mês. Discussão sobre cortes mais profundos no parlamento.", events:[
  ...
  { code:"cz", name:"Tchéquia", coords:[49.82,15.47], status:"stable", changes:1, authority:"MV ČR", imageUrl:"/landmarks/cz.jpg", summary:"Tchéquia mantém regime estável. Employee Card via empregador é principal via. Programa Highly Qualified Employee pra tech tem decisão em 30 dias.", events:[
  ...
  { code:"nz", name:"Nova Zelândia", coords:[-40.90,174.89], status:"stable", changes:2, authority:"INZ", imageUrl:"/landmarks/nz.jpg", summary:"Nova Zelândia reduz Skilled Migrant Category pra 6 pts mínimo + lança Active Investor Plus Green Stream (NZD 5M). Cenário convidativo pra tech, healthcare e investidores verdes.", events:[
  ...
  { code:"cn", name:"China", coords:[35.86,104.20], status:"stable", changes:2, authority:"NIA", imageUrl:"/landmarks/cn.jpg", summary:"China abre porta pra elite global com Z Visa permanente e Hainan FTZ visa-free. NIA sinaliza receptividade tech sem precedente — embora exija nível salarial alto e contribuição estratégica.", events:[
  ...
  { code:"sg", name:"Singapura", coords:[1.35,103.81], status:"stable", changes:1, authority:"MOM", imageUrl:"/landmarks/sg.jpg", summary:"Singapura eleva critério do ONE Pass pra SGD 30k/mês — visando elite global. Fast-track pra ciência aplicada mantido. Política seletiva e estável, foco em ultra-qualificados.", events:[
  ...
  { code:"jp", name:"Japão", coords:[36.20,138.25], status:"stable", changes:1, authority:"ISA", imageUrl:"/landmarks/jp.jpg", summary:"Japão lança track expresso pra Highly-Skilled Professional: PR em 1 ano se atingir 80 pts. Foco em pesquisadores e tech. Sinaliza abertura crescente do mercado tradicionalmente fechado.", events:[
  ...
  // ===== ORIENTE MÉDIO =====
  { code:"ae", name:"Emirados Árabes", coords:[23.42,53.84], status:"stable", changes:2, authority:"ICP", imageUrl:"/landmarks/ae.jpg", summary:"Emirados expandem Golden Visa pra engenheiros de IA, pesquisadores climáticos e médicos especialistas. Freelancer Visa Dubai 100% digital com taxa única AED 7.500. Ambiente regulatório altamente favorável a talentos e capital.", events:[
