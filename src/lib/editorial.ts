...
export const EDITORIAL: Record<string, CountryEditorial> = {
  ...
  mx: {
    community: [
      { title: "Taxas de residência no México mais que dobram em 2026", publishedAt: "2026-07-22", urgency: "urgent", body: "A Ley Federal de Derechos de 2026 elevou em mais de 100% o custo dos principais trâmites de residência no México. A taxa da residência temporária de um ano passou de 5.328,46 para 11.140,74 pesos, e a da residência permanente subiu de 6.494,62 para 13.578,96 pesos. As novas cuotas valem desde 1º de janeiro de 2026.\n\nO governo apresentou o reajuste como um alinhamento a padrões internacionais. Existe uma exceção: quem comprova ao INM que a estadia se deve à preservação da unidade familiar pode pagar metade da tarifa. Antes de agendar qualquer trâmite, confirme o valor vigente no site do INM.", cta: "Planeja pedir residência no México? Some as novas cuotas ao orçamento e confirme a tarifa atual no site do INM antes de marcar atendimento no consulado.", sources: [{ label: "INM · Tarifas de derechos migratorios 2026", url: "https://www.gob.mx/inm/articulos/tarifas-de-derechos-migratorios-2026" }, { label: "DOF · Diario Oficial de la Federación", url: "https://www.dof.gob.mx/" }] },
      { title: "💡 Como a UMA 2026 mexe na comprovação de renda para morar no México", publishedAt: "2026-07-22", urgency: "normal", body: "A residência por solvência econômica, muito usada por aposentados e por quem trabalha de forma remota, exige comprovar renda mensal ou saldo bancário ao consulado mexicano. Esses limites são calculados em múltiplos da UMA, a unidade de referência que o INEGI atualiza a cada ano.\n\nPara 2026, a UMA subiu para 117,31 pesos por dia a partir de 1º de fevereiro, alta de 3,69%. Como os pisos de renda e de poupança acompanham a UMA, o valor pedido tende a subir na mesma proporção. Cada consulado fixa e publica os próprios montantes, então confirme direto no consulado onde pretende aplicar.", cta: "Vai comprovar solvência? Verifique os valores atualizados no consulado mexicano da sua região e organize os extratos dos últimos meses com antecedência.", sources: [{ label: "DOF · Unidad de Medida y Actualización (UMA) 2026", url: "https://www.dof.gob.mx/nota_detalle.php?codigo=5778072&fecha=09/01/2026" }, { label: "SRE · Información Consular", url: "https://informacionconsular.sre.gob.mx/" }] },
    ],
    countryTab: [
      { headline: "México encarece a residência em 2026 e digitaliza o controle de entrada", standfirst: "Ley Federal de Derechos dobra as taxas de residência temporária e permanente, UMA maior pressiona a comprovação de renda e aeroportos ampliam os filtros biométricos.", publishedAt: "2026-07-22", urgency: "urgent", body: "O México tornou mais caro o processo de morar no país em 2026, mesmo sem ser um destino tradicional de imigração de trabalho. A Ley Federal de Derechos elevou em mais de 100% as taxas dos principais trâmites de residência. A residência temporária de um ano passou de 5.328,46 para 11.140,74 pesos, e a permanente subiu de 6.494,62 para 13.578,96 pesos, com as novas cuotas em vigor desde 1º de janeiro. Casos ligados à preservação da unidade familiar podem pagar metade.\n\nO custo de comprovar solvência econômica também subiu. A residência por solvência, caminho comum para aposentados e trabalhadores remotos, exige demonstrar renda ou poupança ao consulado, com limites calculados em múltiplos da UMA. O valor diário da UMA passou para 117,31 pesos a partir de 1º de fevereiro, o que empurra para cima os pisos exigidos. Cada consulado define e divulga os próprios montantes.\n\nNa entrada, o controle avança para os Filtros Migratorios Autónomos, de autosserviço e com verificação facial, já em operação em aeroportos como os da Cidade do México, Cancún, Guadalajara, Los Cabos, Puerto Vallarta, Querétaro e Tijuana. O passageiro elegível valida foto e dados de voo antes de ser internado no país.\n\nPara quem pensa em trabalhar, a via formal quase sempre depende de uma oferta de emprego de empresa mexicana que patrocine o trâmite, um movimento aquecido pelo nearshoring no norte e no Bajío. Como as exigências mudam conforme o caso e o consulado, vale confirmar cada requisito com o INM, com o consulado e, quando possível, com um profissional habilitado antes de assumir compromissos.", keyFacts: ["Residência temporária de um ano subiu de 5.328,46 para 11.140,74 pesos, alta de cerca de 109%", "Residência permanente subiu de 6.494,62 para 13.578,96 pesos, com novas cuotas desde 1º de janeiro de 2026", "UMA diária passou para 117,31 pesos em 1º de fevereiro, elevando os limites de solvência econômica", "Filtros migratórios autônomos com verificação facial ampliados em vários aeroportos", "Trabalho formal para estrangeiro depende de oferta de emprego patrocinada perante o INM"], sources: [{ label: "INM · Tarifas de derechos migratorios 2026", url: "https://www.gob.mx/inm/articulos/tarifas-de-derechos-migratorios-2026" }, { label: "DOF · Diario Oficial de la Federación", url: "https://www.dof.gob.mx/" }, { label: "SRE · Información Consular", url: "https://informacionconsular.sre.gob.mx/" }] },
    ],
    blog: [
      { headline: "O México ficou mais caro para morar, e mais digital para entrar", standfirst: "O reajuste das taxas de residência e a alta da UMA elevam o custo de se instalar no país em 2026, enquanto o nearshoring mantém aberta a porta do trabalho qualificado.", publishedAt: "2026-07-22", urgency: "normal", body: "Durante anos, o México foi visto como um destino de custo baixo para quem queria viver na América do Norte sem os valores dos Estados Unidos ou do Canadá. Em 2026, parte dessa vantagem diminuiu. A Ley Federal de Derechos elevou em mais de 100% as taxas dos principais trâmites de residência, com a temporária de um ano passando de 5.328,46 para 11.140,74 pesos e a permanente de 6.494,62 para 13.578,96 pesos. O governo apresentou o aumento como alinhamento a padrões internacionais.\n\nO reajuste não veio sozinho. A comprovação de solvência econômica, exigida de quem pede residência sem uma oferta de trabalho local, é calculada em múltiplos da UMA, a unidade que o INEGI atualiza todo ano. Com a UMA diária em 117,31 pesos desde fevereiro, os pisos de renda e de poupança pedidos nos consulados sobem na mesma proporção. O efeito prático é que aposentados e trabalhadores remotos precisam mostrar mais recursos do que no ano anterior.\n\nNa fronteira aérea, a mudança é de tecnologia. Os Filtros Migratorios Autónomos, de autosserviço e com verificação facial, se espalham pelos principais aeroportos do país e prometem uma entrada mais rápida para o passageiro elegível. É a face visível de um controle migratório que fica mais digital e mais centrado em dados biométricos.\n\nDo outro lado da balança está o trabalho. O nearshoring, a relocalização de fábricas para perto do mercado americano, mantém aquecida a demanda por engenheiros, técnicos e profissionais bilíngues no norte e no Bajío. Para o estrangeiro, porém, a via formal quase sempre passa por uma oferta de emprego de empresa mexicana que patrocine o trâmite migratório, e profissões regulamentadas ainda exigem revalidação de diploma. Para a comunidade WiseHub, a leitura é direta: o México segue acessível, mas exige mais planejamento financeiro e documental do que exigia, e cada passo merece ser confirmado com o INM, com o consulado e com um profissional habilitado antes da mudança.", tags: ["México", "Residência", "INM", "Nearshoring"], sources: [{ label: "INM · Tarifas de derechos migratorios 2026", url: "https://www.gob.mx/inm/articulos/tarifas-de-derechos-migratorios-2026" }, { label: "DOF · Unidad de Medida y Actualización (UMA) 2026", url: "https://www.dof.gob.mx/nota_detalle.php?codigo=5778072&fecha=09/01/2026" }, { label: "SRE · Información Consular", url: "https://informacionconsular.sre.gob.mx/" }] },
    ],
  },
  pt: {
    community: [
      { title: "Força-tarefa judicial resolve 22.436 processos da AIMA em três meses", publishedAt: "2026-07-21", urgency: "urgent", body: "Uma força-tarefa formada por 28 juízes decidiu 22.436 processos ligados à AIMA entre abril e junho de 2026, o equivalente a cerca de um quinto da fila que estava parada. O balanço é do Conselho Superior dos Tribunais Administrativos e Fiscais e foi divulgado em 20 de julho de 2026.\n\nO grupo começou a trabalhar em abril diante de aproximadamente 124 mil processos pendentes, concentrados em reagrupamento familiar, autorizações de residência e pedidos ligados ao regime CPLP. O ritmo médio foi de 247 decisões por dia, cerca de oito por juiz. A força-tarefa entrou agora em pausa por causa das férias judiciais e retoma em setembro, dentro do plano inicial de seis meses.", cta: "Tem processo parado na AIMA? Confirme se o seu caso já teve decisão e mantenha endereço, telefone e e-mail atualizados no cadastro, porque a notificação segue pelos dados registrados.", sources: [{ label: "CSTAF · Conselho Superior dos Tribunais Administrativos e Fiscais", url: "https://www.cstaf.pt/" }, { label: "AIMA · Agência para a Integração, Migrações e Asilo", url: "https://aima.gov.pt/pt" }] },
    ...
    countryTab: [
      { headline: "Força-tarefa de 28 juízes derruba quase um quinto da fila de processos da AIMA", standfirst: "Balanço do CSTAF divulgado em 20 de julho aponta 22.436 casos decididos entre abril e junho, num acervo que começou em cerca de 124 mil processos.", publishedAt: "2026-07-21", urgency: "urgent", body: "A fila judicial que se formou em torno da AIMA começou a ceder. Segundo balanço do Conselho Superior dos Tribunais Administrativos e Fiscais divulgado em 20 de julho de 2026, uma força-tarefa de 28 juízes decidiu 22.436 processos entre abril e junho, o equivalente a algo perto de um quinto do acervo pendente.\n\nO grupo assumiu o trabalho em abril diante de aproximadamente 124 mil processos parados, formados sobretudo por pedidos de reagrupamento familiar, autorizações de residência e casos ligados ao regime CPLP. O ritmo cresceu ao longo do trimestre: foram 5.691 decisões em abril, 8.705 em maio e 8.040 em junho, uma média de 247 por dia, cerca de oito por juiz. Além das decisões finais, a equipe despachou mais de 47 mil atos processuais, como pedidos de documentos e diligências de instrução.\n\nOs juízes atuam nesses processos em acumulação com as funções regulares, o que ajuda a explicar por que o esforço foi desenhado como temporário. A força-tarefa está agora em pausa por causa das férias judiciais e deve retomar em setembro, cumprindo o plano original de seis meses de atuação.\n\nPara quem tem pedido pendente, o efeito prático é duplo. De um lado, a probabilidade de movimentação processual aumentou de forma concreta. De outro, a pausa de agosto significa que casos não alcançados neste primeiro ciclo tendem a esperar até setembro. Manter os dados de contato atualizados e responder rápido a qualquer notificação é o que evita perder o próprio lugar na fila.", keyFacts: ["22.436 processos decididos entre abril e junho de 2026, segundo o CSTAF", "Acervo inicial de cerca de 124 mil processos pendentes ligados à AIMA", "Força-tarefa com 28 juízes, atuando em acumulação com as funções regulares", "Média de 247 decisões por dia e mais de 47 mil atos processuais no período", "Trabalho em pausa nas férias judiciais, com retomada prevista para setembro"], sources: [{ label: "CSTAF · Conselho Superior dos Tribunais Administrativos e Fiscais", url: "https://www.cstaf.pt/" }, { label: "AIMA · Agência para a Integração, Migrações e Asilo", url: "https://aima.gov.pt/pt" }] },
    ...
    blog: [
      { headline: "A fila da AIMA começou a andar, e o que isso muda no seu planejamento", standfirst: "Vinte e dois mil processos decididos em um trimestre mostram que o gargalo português tem solução. Mas o cronograma agora depende de um calendário judicial, e não só do seu pedido.", publishedAt: "2026-07-21", urgency: "normal", body: "Durante meses, a palavra que melhor descrevia a experiência de quem tinha um processo na AIMA era espera. O acervo acumulado depois da extinção do SEF chegou a cerca de 124 mil casos, e a sensação de imobilidade virou parte do vocabulário de quem tenta se instalar em Portugal. O balanço divulgado em 20 de julho de 2026 pelo Conselho Superior dos Tribunais Administrativos e Fiscais mudou o tom da conversa: 22.436 processos foram decididos entre abril e junho.\n\nO número importa menos pelo tamanho e mais pelo que revela sobre o método. A força-tarefa não criou uma via nova nem alterou requisito algum. Ela colocou 28 juízes trabalhando em acumulação sobre um acervo específico, com foco em reagrupamento familiar, autorizações de residência e casos ligados ao regime CPLP. O ritmo subiu mês a mês, de 5.691 decisões em abril para 8.040 em junho, o que sugere ganho de curva de aprendizado e não um pico isolado.\n\nExiste, porém, um detalhe de calendário que vale internalizar. O esforço foi desenhado para seis meses e está em pausa durante as férias judiciais, com retomada prevista para setembro. Isso significa que agosto tende a ser um mês silencioso, e que a segunda metade do plano vai definir quanto do acervo restante realmente se dissolve. Quem interpretar o silêncio de agosto como novo travamento pode tomar decisões precipitadas, como reiniciar pedidos ou trocar de via sem necessidade.\n\nPara a comunidade WiseHub, a leitura prática se resume a três movimentos. Primeiro, manter endereço, telefone e e-mail rigorosamente atualizados, porque uma decisão que não consegue ser notificada é uma decisão que não produz efeito na sua vida. Segundo, organizar desde já a documentação que costuma ser exigida em diligência, evitando que um pedido de documento adie o seu caso por semanas. Terceiro, tratar setembro como o marco relevante do seu planejamento, e não agosto. A fila voltou a andar, e quem estiver com a papelada pronta é quem aproveita o movimento.", tags: ["Portugal", "AIMA", "Residência", "Reagrupamento familiar"], sources: [{ label: "CSTAF · Conselho Superior dos Tribunais Administrativos e Fiscais", url: "https://www.cstaf.pt/" }, { label: "AIMA · Agência para a Integração, Migrações e Asilo", url: "https://aima.gov.pt/pt" }] },
    ],
  },
  es: {
    community: [
  ...
  de: {
    community: [
      { title: "Comissão Europeia pede que a Alemanha encerre os controles extras de fronteira", publishedAt: "2026-07-21", urgency: "normal", body: "O comissário europeu para Migração, Magnus Brunner, apelou à Alemanha para que suspenda os controles adicionais nas fronteiras internas, argumentando que os números da migração vêm caindo e que as novas regras europeias de asilo já dão ao país as ferramentas de que precisa. Os controles estão em vigor desde setembro de 2024 e foram prorrogados até setembro de 2026.\n\nO tema também passa pelos tribunais. Em maio de 2026, o Tribunal Administrativo de Koblenz entendeu que a prática contraria o acordo de Schengen, que trata os controles internos como medida excepcional e temporária. O Ministério do Interior anunciou recurso e o ministro Alexander Dobrindt afirmou que a fiscalização continua. Na prática, quem cruza a fronteira alemã por terra deve seguir contando com verificação de documentos.", cta: "Vai entrar na Alemanha por via terrestre? Leve passaporte e o comprovativo do seu status de residência sempre à mão, e reserve folga no horário em travessias de ônibus, trem ou carro.", sources: [{ label: "Comissão Europeia · Migração e Assuntos Internos", url: "https://home-affairs.ec.europa.eu/" }, { label: "BMI · Ministério Federal do Interior (Alemanha)", url: "https://www.bmi.bund.de/" }] },
    ...
    countryTab: [
      { headline: "Bruxelas cobra o fim dos controles alemães nas fronteiras internas, e Berlim resiste", standfirst: "Comissário Magnus Brunner diz que a medida perdeu justificativa, enquanto o Ministério do Interior mantém a fiscalização mesmo após decisão judicial contrária.", publishedAt: "2026-07-21", urgency: "normal", body: "A Alemanha vive um impasse entre o próprio governo, os tribunais e a Comissão Europeia sobre os controles adicionais nas fronteiras internas do espaço Schengen. O comissário europeu para Migração, Magnus Brunner, apelou publicamente para que o país encerre a prática, sustentando que os números da migração recuaram e que o novo pacto europeu de asilo já oferece instrumentos suficientes.\n\nOs controles foram introduzidos em setembro de 2024, sob a justificativa de conter o terrorismo islamista e a criminalidade grave, e desde então vêm sendo prorrogados, com a extensão atual alcançando setembro de 2026. O acordo de Schengen prevê que a reintrodução de fronteiras internas seja excepcional e limitada no tempo, e é exatamente esse ponto que alimenta a disputa.\n\nEm maio de 2026, o Tribunal Administrativo de Koblenz concluiu que a prática alemã viola as regras de Schengen. O Ministério do Interior informou que recorre da decisão, e o ministro Alexander Dobrindt declarou que a fiscalização permanece. A pressão política também vem de dentro da Europa: o ex-presidente do Parlamento Europeu, Martin Schulz, afirmou que os controles não produziram resultado e contrariam o direito europeu.\n\nPara quem mora na Alemanha ou planeja chegar, a consequência é operacional, não jurídica. Enquanto o impasse não se resolve, a travessia terrestre pelas fronteiras alemãs segue sujeita a verificação de documentos, o que pesa sobretudo em deslocamentos de ônibus, trem e carro entre países vizinhos.", keyFacts: ["Controles nas fronteiras internas em vigor desde setembro de 2024, prorrogados até setembro de 2026", "Comissário europeu para Migração, Magnus Brunner, pediu o encerramento da medida", "Tribunal Administrativo de Koblenz decidiu em maio de 2026 que a prática viola o acordo de Schengen", "Ministério do Interior recorre da decisão e mantém a fiscalização"], sources: [{ label: "Comissão Europeia · Migração e Assuntos Internos", url: "https://home-affairs.ec.europa.eu/" }, { label: "BMI · Ministério Federal do Interior (Alemanha)", url: "https://www.bmi.bund.de/" }] },
    ...
    blog: [
      { headline: "Schengen sob teste: o que os controles alemães revelam sobre a livre circulação", standfirst: "Uma medida apresentada como temporária em 2024 já dura quase dois anos, sobreviveu a uma decisão judicial contrária e virou termômetro do quanto a fronteira interna europeia ainda é aberta.", publishedAt: "2026-07-21", urgency: "normal", body: "A promessa mais tangível do projeto europeu, para quem vive no continente, sempre foi a de atravessar países sem parar. É essa promessa que está sendo testada na Alemanha desde setembro de 2024, quando o país reintroduziu controles nas fronteiras internas do espaço Schengen, apresentando a medida como resposta temporária a riscos de terrorismo e criminalidade grave.\n\nQuase dois anos depois, o adjetivo temporário ficou difícil de sustentar. A extensão em vigor alcança setembro de 2026, e o desenho jurídico de Schengen prevê justamente o contrário: reintrodução excepcional, motivada e limitada no tempo. Foi nesse ponto que o Tribunal Administrativo de Koblenz se apoiou, em maio de 2026, para concluir que a prática alemã contraria as regras europeias. O governo recorreu e manteve a fiscalização, o que produz uma situação incomum, em que uma medida declarada ilegal em primeira instância continua a ser aplicada todos os dias.\n\nA Comissão Europeia entrou no debate pelo argumento dos números. Segundo o comissário para Migração, Magnus Brunner, os fluxos migratórios recuaram e o novo pacto de asilo já entrega aos Estados os mecanismos necessários, o que retiraria a base fática do controle permanente. Do lado alemão, o Ministério do Interior sustenta que a avaliação de risco é prerrogativa nacional. As duas leituras são defensáveis, e é exatamente por isso que o caso importa além da Alemanha: ele vai ajudar a definir quanta margem cada país tem para fechar a própria fronteira interna sem sair do bloco.\n\nPara a comunidade WiseHub, convém separar o ruído do efeito prático. Nada disso altera o seu direito de residência, o seu visto ou a validade da sua autorização. O que muda é a rotina de deslocamento: enquanto o impasse durar, cruzar a fronteira alemã por terra significa contar com verificação de documentos e algum atraso. Quem viaja com frequência entre países vizinhos ganha em manter passaporte e comprovante de status sempre acessíveis, e em tratar a travessia como etapa que exige tempo, não como formalidade invisível.", tags: ["Alemanha", "Schengen", "Fronteiras", "União Europeia"], sources: [{ label: "Comissão Europeia · Migração e Assuntos Internos", url: "https://home-affairs.ec.europa.eu/" }, { label: "BMI · Ministério Federal do Interior (Alemanha)", url: "https://www.bmi.bund.de/" }] },
  ...
  it: {
    community: [
      { title: "Certidão de trânsito em julgado trava a última etapa da cidadania em seis tribunais italianos", publishedAt: "2026-07-21", urgency: "normal", body: "Ganhar a ação de reconhecimento da cidadania italiana deixou de ser o fim do caminho para muita gente. Seis tribunais concentram hoje os piores atrasos na emissão da certidão de trânsito em julgado: Veneza, Trieste, Florença, Bolonha, Gênova e Nápoles. O gargalo não está no juiz, e sim nas cancellerie, as secretarias judiciais que certificam que a sentença se tornou definitiva.\n\nA explicação apontada em documentos dos próprios tribunais é a realocação de pessoal para as metas do PNRR, o plano italiano de recuperação financiado pela União Europeia. Como as cortes priorizaram publicar sentenças para cumprir esses indicadores, faltou gente na etapa seguinte. Sem a certidão, os oficiais do registro civil recusam a transcrição do reconhecimento nos assentos, e sem transcrição não sai passaporte. A Corte di Cassazione já decidiu, em casos concretos, que a sentença de reconhecimento é autoexecutável, mas essas decisões não vinculam os oficiais, que seguem exigindo o documento.", cta: "Ganhou a ação e está esperando a certidão? Acompanhe o pedido diretamente na cancelleria do tribunal e verifique se há taxa de registro pendente, porque alguns tribunais condicionam a emissão à confirmação do pagamento.", sources: [{ label: "Ministero della Giustizia · Serviços dos tribunais", url: "https://www.giustizia.it/" }, { label: "Corte Suprema di Cassazione (oficial)", url: "https://www.cortedicassazione.it/" }] },
    ...
    countryTab: [
      { headline: "Vitória na Justiça, passaporte na espera: o gargalo das cancellerie italianas", standfirst: "Atraso na certidão de trânsito em julgado atinge Veneza, Trieste, Florença, Bolonha, Gênova e Nápoles, e trava a transcrição do reconhecimento no registro civil.", publishedAt: "2026-07-21", urgency: "normal", body: "O reconhecimento judicial da cidadania italiana ganhou um obstáculo que não estava no roteiro. Depois de vencer a ação, o requerente precisa da certidão de trânsito em julgado, o documento que atesta que a sentença se tornou definitiva. É justamente essa peça que vem demorando, e o atraso se concentra em seis tribunais bastante procurados por descendentes: Veneza, Trieste, Florença, Bolonha, Gênova e Nápoles.\n\nA raiz do problema é administrativa. Segundo documentos dos próprios tribunais, a emissão de certidões em processos de cidadania ficou notavelmente mais lenta por causa de carência grave de pessoal, com servidores deslocados para as metas do PNRR, o plano de recuperação financiado pela União Europeia. As cortes priorizaram publicar sentenças, que é o indicador cobrado, e a etapa seguinte, a cargo das cancellerie, ficou descoberta.\n\nO efeito prático é uma fila depois da fila. Sem a certidão, o oficial do registro civil se recusa a transcrever o reconhecimento nos assentos de nascimento e casamento, e a transcrição é pré-requisito para a emissão do passaporte italiano. Alguns tribunais acrescentaram ainda uma condição: só liberam o documento após a confirmação, pela administração tributária, de que as taxas de registro foram pagas.\n\nHá um contraponto jurídico relevante. A Corte di Cassazione já assentou, em casos concretos, que a sentença de reconhecimento da cidadania é autoexecutável e dispensaria a certidão. O problema é que essas decisões não vinculam os oficiais do registro civil, que continuam exigindo o documento. Advogados que atuam na área defendem uma circular do Ministério do Interior para uniformizar o procedimento e aliviar a pressão sobre os tribunais. Enquanto isso não acontece, a expectativa é de que a situação só melhore depois do recesso de agosto.", keyFacts: ["Atraso concentrado em seis tribunais: Veneza, Trieste, Florença, Bolonha, Gênova e Nápoles", "Causa apontada: carência de pessoal nas cancellerie, com servidores voltados às metas do PNRR", "Sem a certidão, o registro civil não transcreve o reconhecimento e o passaporte não é emitido", "Alguns tribunais condicionam a emissão à confirmação do pagamento das taxas de registro", "A Corte di Cassazione já considerou a sentença autoexecutável, mas a decisão não vincula os oficiais do registro"], sources: [{ label: "Ministero della Giustizia · Serviços dos tribunais", url: "https://www.giustizia.it/" }, { label: "Corte Suprema di Cassazione (oficial)", url: "https://www.cortedicassazione.it/" }] },
    ...
    blog: [
      { headline: "A etapa que ninguém coloca no cronograma da cidadania italiana", standfirst: "Entre a sentença favorável e o passaporte na mão existe um trecho burocrático que hoje é o mais lento de todos. Entender onde ele trava evita meses perdidos e decisões erradas.", publishedAt: "2026-07-21", urgency: "normal", body: "Quem monta o próprio cronograma da cidadania italiana costuma pensar em três blocos: reunir documentos, ajuizar a ação e ganhar. O que a experiência recente mostra é que existe um quarto bloco, quase sempre esquecido no planejamento, e que atualmente é o mais demorado. Entre a sentença favorável e o passaporte, é preciso obter a certidão de trânsito em julgado e transcrever o reconhecimento no registro civil.\n\nEsse trecho depende de uma estrutura específica: as cancellerie, as secretarias judiciais responsáveis por certificar que a decisão se tornou definitiva. E é ali que a corda arrebentou. Com servidores realocados para cumprir as metas do PNRR, o plano italiano de recuperação, os tribunais passaram a priorizar a publicação de sentenças, que é o indicador cobrado, deixando a certificação sem gente suficiente. O resultado aparece de forma concentrada em Veneza, Trieste, Florença, Bolonha, Gênova e Nápoles.\n\nO detalhe que torna o gargalo tão frustrante é a sua natureza. Não se trata de mérito, de prova, de linha genealógica ou de interpretação do Decreto Tajani. O direito já foi reconhecido por um juiz. O que falta é um carimbo. A Corte di Cassazione chegou a decidir, em casos concretos, que a sentença de reconhecimento é autoexecutável e não precisaria da certidão, mas o entendimento não vincula os oficiais do registro civil, que seguem exigindo o papel antes de transcrever. Sem transcrição, não há passaporte, e o processo fica parado numa etapa puramente formal.\n\nPara a comunidade WiseHub, ficam três orientações concretas. A primeira é de expectativa: ao planejar prazos, some ao tempo do processo o tempo de certificação e transcrição, e não trate a sentença como linha de chegada. A segunda é de acompanhamento ativo: o pedido de certidão precisa ser monitorado junto à cancelleria, e vale checar se há taxa de registro pendente, porque alguns tribunais condicionam a emissão à confirmação do pagamento. A terceira é de calendário: a leitura de quem atua na área é que a situação só deve destravar depois do recesso de agosto, o que faz de setembro o mês em que essa fila específica volta a andar.", tags: ["Itália", "Cidadania", "Trânsito em julgado", "Registro civil"], sources: [{ label: "Ministero della Giustizia · Serviços dos tribunais", url: "https://www.giustizia.it/" }, { label: "Corte Suprema di Cassazione (oficial)", url: "https://www.cortedicassazione.it/" }] },
  ...
  dk: {
    community: [
      { urgency: "normal", title: "Conselho da Europa alerta a Dinamarca sobre riscos dos centros de retorno fora da UE", body: "O comissário de Direitos Humanos do Conselho da Europa, Michael O'Flaherty, enviou uma carta alertando a Dinamarca, ao lado de Alemanha, Áustria, Holanda e Grécia, sobre os riscos de instalar centros de retorno fora das fronteiras da União Europeia. Segundo o comissário, os planos trazem riscos significativos a direitos humanos, incluindo maus-tratos e detenção arbitrária, e a recomendação é adotar salvaguardas específicas para preservar a proteção jurídica das pessoas nesses centros. A informação foi divulgada pela emissora pública DR em 18 de julho de 2026.\n\nO Conselho da Europa é uma organização de 46 países, distinta da União Europeia, voltada a democracia e direitos humanos, e seu alerta não altera nenhuma regra. O Parlamento Europeu já havia aprovado, em junho de 2026, o marco que autoriza esses centros, e o ministro dinamarquês da Migração, Morten Bødskov, respondeu que os projetos europeus cumprem as convenções exigidas. O tema segue como prioridade declarada da primeira-ministra Mette Frederiksen.", cta: "Como o assunto continua em movimento no nível europeu, acompanhe as regras de asilo e residência direto no Ministério da Imigração e Integração da Dinamarca antes de tomar decisões.", sources: [{ label: "DR Nyheder · Emissora pública dinamarquesa", url: "https://www.dr.dk/nyheder/politik/europaraadet-advarer-danmark-mod-risikoen-ved-eu-s-udrejsecentre" }, { label: "Udlændinge- og Integrationsministeriet (oficial)", url: "https://uim.dk/" }], publishedAt: "2026-07-23" },
  ...
  at: {
    community: [
      { urgency: "normal", title: "Interior austríaco declara migração líquida negativa, e a palavra escolhida vira alvo de crítica", body: "O Ministério do Interior da Áustria anunciou, em 21 de julho de 2026, ter alcançado o que chamou de Minuszuwanderung, a migração líquida negativa, quando as saídas passam a superar as entradas. Segundo a pasta, o número de deportações superou o de pedidos de asilo, os pedidos de asilo caíram ao menor nível em 23 anos e o Estado teria economizado mais de 125 milhões de euros em provisão básica desde 2023. O ministro Gerhard Karner disse querer assegurar esse resultado de forma duradoura.\n\nO anúncio veio cercado de polêmica pela própria palavra. O jornal Der Standard registrou que Minuszuwanderung carrega conotação de extrema direita, o que reacendeu o debate sobre o tom da política migratória austríaca. Cabe uma distinção prática: trata-se de um balanço estatístico e político sobre asilo e migração irregular, sem mudança de lei ou de prazo, e as vias regulares de imigração qualificada continuam as mesmas.", cta: "Se o seu plano é a Áustria por trabalho ou estudo, o caminho comum não muda: a Red-White-Red Card e o sistema de pontos seguem valendo, com as regras publicadas no portal oficial migration.gv.at.", sources: [{ label: "BMI · Ministério do Interior da Áustria (oficial)", url: "https://www.bmi.gv.at/news.aspx?id=6B566C6E756C6F43546E383D" }, { label: "Der Standard · Inland", url: "https://www.derstandard.at/story/3000000332450/karner-auf-abwegen-mit-minuszuwanderung-benutzt-er-einen-rechtsextremen-begriff" }], publishedAt: "2026-07-23" },
    ...
    blog: [
      { urgency: "normal", headline: "Quando o Estado comemora migração negativa: o que a 'Minuszuwanderung' austríaca diz, e o que ela não diz", standfirst: "A Áustria anunciou que as saídas superaram as entradas e que os pedidos de asilo estão no menor patamar em mais de duas décadas. O número é real, o vocabulário é político, e as vias de imigração qualificada continuam de pé.", body: "Há anúncios de governo que valem menos pelo número e mais pela palavra escolhida para embrulhá-lo. O que o Ministério do Interior da Áustria comunicou em 21 de julho de 2026 é um desses casos. A pasta declarou ter atingido a Minuszuwanderung, a migração líquida negativa, e sustentou o feito com dados concretos: deportações em volume maior que os pedidos de asilo, pedidos de asilo no menor nível em 23 anos e uma economia superior a 125 milhões de euros em provisão básica desde 2023.\n\nO dado, em si, descreve um movimento real. A Áustria vinha reduzindo estrutura de fronteira e endurecendo o discurso sobre migração irregular, e o balanço de julho apenas coroa essa direção. O ministro Gerhard Karner afirmou que pretende tornar o resultado duradouro, o que sinaliza continuidade de uma política de contenção, não uma virada pontual.\n\nA controvérsia, no entanto, nasceu da própria palavra. O jornal Der Standard apontou que Minuszuwanderung é um termo com conotação de extrema direita, e a crítica não é preciosismo linguístico. Em política migratória, o vocabulário oficial molda a forma como um país se apresenta a quem pensa em chegar, e adotar um conceito marcado por essa origem diz algo sobre o clima que a Áustria projeta para fora.\n\nPara quem acompanha imigração com objetivo prático, porém, vale separar o que mudou do que não mudou. O anúncio é um balanço estatístico e político, voltado a asilo e migração irregular. Não há lei nova, portaria nova nem prazo novo. As vias ordinárias de imigração qualificada permanecem intactas: a Red-White-Red Card segue como principal porta para profissionais de fora do Espaço Econômico Europeu, com o mesmo sistema de pontos que avalia qualificação, experiência, idade e idioma.\n\nO recado que fica, para a comunidade WiseHub, é de leitura fria. Um país pode, ao mesmo tempo, estreitar as portas do asilo e manter abertas as portas do trabalho qualificado, e confundir os dois canais leva a decisões erradas. A Áustria continua um destino viável para quem se enquadra nos critérios do seu sistema de pontos, ainda que o noticiário migratório do país soe, hoje, mais duro do que ontem.", tags: ["Áustria", "Política migratória", "Asilo", "Red-White-Red Card"], sources: [{ label: "BMI · Ministério do Interior da Áustria (oficial)", url: "https://www.bmi.gv.at/news.aspx?id=6B566C6E756C6F43546E383D" }, { label: "Der Standard · Inland", url: "https://www.derstandard.at/story/3000000332450/karner-auf-abwegen-mit-minuszuwanderung-benutzt-er-einen-rechtsextremen-begriff" }], publishedAt: "2026-07-23" },
  ...
  au: {
    community: [
      {
        title: "Austrália publica novas prioridades e limites anuais para o visto humanitário 202",
        publishedAt: "2026-07-21",
        urgency: "urgent",
        body:
          "O governo australiano publicou em 17 de julho de 2026 dois instrumentos legislativos que reorganizam o visto humanitário Global Special Humanitarian, a subclasse 202. O primeiro, LIN 26/036, fixa as prioridades da Commonwealth para a seleção dos casos. O segundo, LIN 26/035, estabelece um limite anual de pedidos para cada organização proponente credenciada, a chamada APO, válido para o ano fiscal iniciado em 1º de julho de 2026.\n\nAs prioridades passam a considerar características do requerente principal, e não apenas a região de origem: idade entre 18 e 50 anos, domínio de inglês falado e escrito compatível com vida independente e segurança no trabalho, e capacidade de sustentar a si mesmo em até doze meses por emprego ou qualificação. O ponto mais sensível está no limite anual: pedidos apresentados por uma organização acima da sua cota alocada são considerados inválidos.",
        cta: "Vai apresentar um pedido da subclasse 202 por uma organização proponente? Confirme com ela a cota disponível antes de protocolar, porque pedido acima do limite anual não é apenas recusado, é tratado como inválido.",
        sources: [
          { label: "Federal Register of Legislation (Austrália)", url: "https://www.legislation.gov.au/" },
          { label: "Home Affairs · Programa Humanitário", url: "https://immi.homeaffairs.gov.au/what-we-do/refugee-and-humanitarian-program" },
        ],
      },
      {
    ...
    countryTab: [
      {
        headline: "Dois instrumentos redesenham o visto humanitário australiano 202 e criam cota por organização",
        standfirst:
          "Publicados em 17 de julho de 2026, o LIN 26/036 fixa prioridades de seleção e o LIN 26/035 impõe limite anual de pedidos por organização proponente, com invalidade para quem exceder.",
        publishedAt: "2026-07-21",
        urgency: "urgent",
        body:
          "A Austrália alterou o funcionamento do Global Special Humanitarian, a subclasse 202 do seu programa humanitário, por meio de dois instrumentos legislativos publicados em 17 de julho de 2026. Juntos, eles mexem nos dois pontos que mais importam para quem depende dessa via: quem tem prioridade e quantos pedidos cada porta de entrada pode apresentar.\n\nO instrumento LIN 26/036 especifica as prioridades da Commonwealth para a subclasse 202. O desenho deslocou o eixo da seleção para características individuais do requerente principal. Entram no cálculo a faixa etária de 18 a 50 anos, a demonstração de inglês falado e escrito suficiente para sustentar vida independente, segurança no ambiente de trabalho e empregabilidade, e a perspectiva de autossuficiência financeira dentro de doze meses, por meio de emprego ou de qualificação profissional aproveitável.\n\nO instrumento LIN 26/035 trata da vazão. Cada organização proponente credenciada, conhecida pela sigla APO, passa a ter uma alocação anual de pedidos para o ano fiscal iniciado em 1º de julho de 2026. A consequência prevista é dura: pedidos apresentados além da cota da organização são tratados como inválidos, e não simplesmente recusados. A diferença é relevante, porque um pedido inválido não segue para análise de mérito.\n\nPara famílias que acompanham processos por essa via, o efeito prático é de calendário e de coordenação. A escolha da organização proponente e o momento de protocolar passam a interagir diretamente com a cota disponível, o que torna a conversa prévia com a APO uma etapa obrigatória, e não um detalhe operacional.",
        keyFacts: [
          "Dois instrumentos publicados em 17 de julho de 2026: LIN 26/036 e LIN 26/035",
          "LIN 26/036 fixa prioridades da Commonwealth para a subclasse 202 (Global Special Humanitarian)",
          "Prioridades consideram idade entre 18 e 50 anos, inglês falado e escrito e autossuficiência em até doze meses",
          "LIN 26/035 cria alocação anual de pedidos por organização proponente (APO) para o ano fiscal iniciado em 1º de julho de 2026",
          "Pedidos acima da cota da organização são considerados inválidos",
        ],
        sources: [
          { label: "Federal Register of Legislation (Austrália)", url: "https://www.legislation.gov.au/" },
          { label: "Home Affairs · Programa Humanitário", url: "https://immi.homeaffairs.gov.au/what-we-do/refugee-and-humanitarian-program" },
    ...
    blog: [
      {
        headline: "Quando a cota vira regra: o que a reforma do visto 202 diz sobre o humanitário australiano",
        standfirst:
          "A Austrália não mudou o tamanho do seu programa humanitário, mudou quem entra e por qual porta. É uma reorganização silenciosa, com efeitos bem concretos sobre expectativas.",
        publishedAt: "2026-07-21",
        urgency: "normal",
        body:
          "Reformas migratórias costumam ser anunciadas pelo número. Tantas vagas a mais, tantas a menos. A mudança que a Austrália fez na subclasse 202, o Global Special Humanitarian, não segue esse roteiro: ela opera sobre critério e sobre vazão, dois elementos que quase nunca chegam ao noticiário, mas que definem na prática quem consegue apresentar um pedido e quem fica de fora.\n\nO primeiro movimento está nas prioridades. O instrumento LIN 26/036 desloca o foco da seleção para características do requerente principal, entre elas a faixa etária de 18 a 50 anos, o domínio de inglês falado e escrito e a expectativa de autossuficiência financeira em até doze meses. Lida isoladamente, é uma lista razoável de indicadores de integração. Lida no contexto de um visto humanitário, ela introduz uma tensão conhecida: o programa passa a favorecer quem já reúne condições de se estabelecer rápido, perfil que nem sempre coincide com o de maior vulnerabilidade.\n\nO segundo movimento é o que muda a rotina de quem opera esses pedidos. O instrumento LIN 26/035 aloca a cada organização proponente credenciada uma cota anual de pedidos. Exceder a cota não gera fila nem espera: gera invalidade. Um pedido inválido não é analisado no mérito, o que transforma a gestão da cota em variável estratégica. Escolher a organização certa e protocolar no momento certo passa a pesar tanto quanto a solidez do próprio caso.\n\nPara a comunidade WiseHub, a lição extrapola a Austrália. Cada vez mais, as regras que realmente determinam o resultado não estão no texto do visto, e sim nos instrumentos técnicos publicados ao longo do ano, com números de série pouco memoráveis. Quem acompanha apenas as páginas de apresentação dos programas fica sabendo tarde. E, no caso específico da subclasse 202, saber tarde pode significar um pedido apresentado fora da cota, que nem chega a ser lido.",
        tags: ["Austrália", "Visto humanitário", "Subclasse 202", "Legislação"],
        sources: [
          { label: "Federal Register of Legislation (Austrália)", url: "https://www.legislation.gov.au/" },
          { label: "Home Affairs · Programa Humanitário", url: "https://immi.homeaffairs.gov.au/what-we-do/refugee-and-humanitarian-program" },
        ],
