...
export const EDITORIAL: Record<string, CountryEditorial> = {
  ...
  hr: {
    community: [
      { title: "Croácia abre 1,2 milhão de euros pra estimular o retorno da diáspora", body: "O Ministério da Demografia e Imigração da Croácia (Ministarstvo demografije i useljeništva) abriu em julho de 2026 um edital de 1,2 milhão de euros pra financiar projetos que incentivem o retorno, a imigração e a integração da diáspora croata, seus descendentes e familiares. O objetivo declarado é a revitalização demográfica do país, criando condições pra que quem tem raízes croatas volte e se estabeleça na vida social, econômica e cultural da Croácia.\n\nOs recursos vão pra organizações da sociedade civil, associações, fundações e entidades religiosas, que atuem na Croácia ou no exterior. As candidaturas seguem abertas até 10 de agosto de 2026, com apoios que variam de 4 mil a 40 mil euros por projeto, conforme a área.", cta: "Se você tem ascendência croata e pensa em se mudar, acompanhe pelo site oficial do Ministério da Demografia e Imigração, porque o país vem estruturando incentivos específicos pra quem retorna.", sources: [{ label: "Ministarstvo demografije i useljeništva (MDU)", url: "https://mdu.gov.hr/useljenistvo/7090" }], publishedAt: "2026-07-11" },
      { title: "💡 O dinheiro vai pra projetos, não direto pro bolso do imigrante", body: "Vale entender bem como esse edital croata funciona pra não criar expectativa errada. O 1,2 milhão de euros não é pago a pessoas físicas que se mudam, e sim a organizações da sociedade civil que tocam projetos de acolhimento, divulgação e integração da diáspora. Na prática, é o Estado croata bancando a estrutura que recebe quem volta.\n\nSão seis áreas prioritárias, de eventos de retorno e materiais de orientação a redes profissionais, atividades culturais e programas de integração pra crianças e jovens de até 30 anos. Os valores por projeto vão de 4 mil euros a 10 mil euros na área de conteúdo informativo e chegam a 40 mil euros nas demais.", cta: "Quem é de organização de croatas no exterior pode se candidatar até 10 de agosto de 2026. Quem é candidato individual à mudança deve olhar as vias de residência e trabalho, que seguem trilhos próprios.", sources: [{ label: "Ministarstvo demografije i useljeništva (MDU)", url: "https://mdu.gov.hr/useljenistvo/7090" }], publishedAt: "2026-07-11" },
    ],
    countryTab: [
      { headline: "Croácia aposta 1,2 milhão de euros no retorno da própria diáspora", standfirst: "Novo edital do Ministério da Demografia e Imigração financia projetos de retorno, imigração e integração de croatas no exterior, com prazo até 10 de agosto de 2026.", body: "A Croácia colocou dinheiro onde está sua maior aposta demográfica. Em julho de 2026, o Ministério da Demografia e Imigração abriu um edital de 1,2 milhão de euros pra financiar projetos voltados ao retorno, à imigração e à integração da diáspora croata, seus descendentes e familiares. A meta declarada é a revitalização demográfica de um país que, como boa parte da Europa Central, convive com envelhecimento e saída de gente.\n\nOs recursos são destinados a organizações da sociedade civil, associações, fundações e entidades ligadas à Igreja Católica e a outras comunidades religiosas, que operem dentro da Croácia ou no exterior, em países onde vivem comunidades croatas. Cada organização pode apresentar uma proposta por área prioritária, sozinha ou em parceria, e instituições públicas croatas podem entrar como parceiras de projeto.\n\nO edital se divide em seis áreas prioritárias, que vão de eventos de incentivo ao retorno e materiais de orientação sobre como voltar e se instalar, a programas de contato profissional entre a diáspora e a Croácia, eventos culturais e esportivos, apoio à integração escolar de crianças e jovens e programas de intercâmbio pra jovens de até 30 anos. Os apoios por projeto vão de 4 mil euros a 10 mil euros na área de conteúdo informativo e chegam a 40 mil euros nas demais, com candidaturas abertas até 10 de agosto de 2026.", keyFacts: ["Edital de 1,2 milhão de euros do Ministério da Demografia e Imigração (MDU)", "Foco em retorno, imigração e integração da diáspora croata, descendentes e familiares", "Elegíveis: organizações da sociedade civil na Croácia ou no exterior", "Apoios de 4 mil a 40 mil euros por projeto, com prazo até 10 de agosto de 2026"], sources: [{ label: "Ministarstvo demografije i useljeništva (MDU)", url: "https://mdu.gov.hr/useljenistvo/7090" }], publishedAt: "2026-07-11" },
    ],
    blog: [
      { headline: "Croácia trata imigração como política demográfica, e o alvo é a própria diáspora", standfirst: "Ao financiar quem organiza o retorno de croatas do exterior, o país mostra um modelo de imigração que começa pelos laços de origem, não pela vaga de trabalho.", body: "Boa parte do debate migratório na Europa gira em torno de atrair mão de obra estrangeira pra tapar buracos no mercado. A Croácia acaba de reforçar um caminho diferente e complementar: usar dinheiro público pra chamar de volta a própria gente. O edital de 1,2 milhão de euros aberto em julho de 2026 pelo Ministério da Demografia e Imigração deixa isso explícito ao financiar projetos de retorno, imigração e integração da diáspora croata.\n\nO desenho do programa diz muito sobre a estratégia. Em vez de repassar valores direto a quem se muda, o Estado financia organizações da sociedade civil que criam a ponte, eventos de incentivo ao retorno, materiais de orientação, redes profissionais, atividades culturais e apoio à integração de crianças e jovens. É uma aposta na infraestrutura de acolhimento, no tecido que recebe o recém-chegado, e não apenas no visto que o deixa entrar.\n\nO recorte por descendência tem lógica demográfica clara. Países da Europa Central que perderam população pra emigração enxergam nos descendentes uma imigração de menor atrito cultural, gente com laços de língua, família e identidade que tende a se integrar mais rápido. A Croácia, dentro do euro e do espaço Schengen desde 2023, soma a esse apelo afetivo a estabilidade de um Estado-membro da União Europeia.\n\nPra comunidade WiseHub, fica um aprendizado que vale além da Croácia. Existe uma faixa de imigração que passa pela origem, e não pela oferta de emprego, e ela costuma trazer incentivos próprios, de programas de retorno a benefícios fiscais pra quem volta. Quem tem ascendência num país europeu deve mapear essas trilhas com a mesma atenção que dá aos vistos de trabalho, porque muitas vezes elas são mais rápidas, mais baratas e mais bem-amparadas pelo próprio Estado de destino.", tags: ["Croácia", "Diáspora", "Retorno", "Política demográfica"], sources: [{ label: "Ministarstvo demografije i useljeništva (MDU)", url: "https://mdu.gov.hr/useljenistvo/7090" }], publishedAt: "2026-07-11" },
    ],
  },
  sk: {
    community: [
  ...
  nl: {
    community: [
      { publishedAt: "2026-07-08", title: "Holanda cobra os municípios e aperta o acolhimento de asilo", body: "A Holanda deu mais um passo na sua fase migratória mais rígida. No início de julho de 2026, o governo colocou os dez primeiros municípios sob supervisão por não organizarem vagas suficientes de acolhimento para requerentes de asilo, e o ministro responsável pela pasta, Van den Brink, ampliou a pressão sobre as prefeituras para que cumpram a obrigação de receber refugiados.\n\nO episódio serve de leitura de clima para quem planeja migrar. O país não fechou as portas ao talento qualificado, mas passou a administrar a imigração com mão firme, cobrando resultado tanto de quem chega quanto das próprias autoridades locais.", cta: "Acompanhe a política de asilo e migração diretamente no portal do governo holandês (rijksoverheid.nl) para entender o cenário antes de planejar a mudança.", sources: [{ label: "Rijksoverheid · Política de asilo e migração", url: "https://www.rijksoverheid.nl/themas/migratie-en-reizen/asielbeleid" }] },
      { publishedAt: "2026-07-08", title: "💡 Trabalho qualificado: o patrocínio da IND continua sendo a chave", body: "Para o profissional que quer trabalhar na Holanda, a via principal segue a do Highly Skilled Migrant, que depende de um empregador reconhecido pela IND, o serviço de imigração holandês. Esse empregador credenciado assume o pedido em nome do trabalhador, e o salário mínimo exigido vem sendo elevado, com um patamar reduzido para recém-graduados.\n\nEm um ambiente político mais duro com a imigração, garantir uma oferta de uma empresa que já é sponsor reconhecida faz toda a diferença. Sem esse patrocínio formal, o caminho do migrante altamente qualificado não abre, por melhor que seja o currículo.", cta: "Confirme na lista pública de sponsors reconhecidos da IND se o empregador está habilitado a patrocinar o seu visto antes de fechar contrato.", sources: [{ label: "IND, serviço de imigração da Holanda", url: "https://ind.nl/en" }] },
    ],
    countryTab: [
      { publishedAt: "2026-07-08", headline: "Holanda endurece a governança migratória e cobra os municípios", standfirst: "O governo coloca os dez primeiros municípios sob supervisão por acolhimento de asilo insuficiente, enquanto o visto de talento qualificado segue dependente de patrocínio e salário alto.", body: "A Holanda reforçou em julho de 2026 o tom rígido de sua política migratória. O governo colocou os dez primeiros municípios sob supervisão por não organizarem vagas suficientes de acolhimento para requerentes de asilo, e o ministro responsável pela pasta, Van den Brink, ampliou a pressão sobre as prefeituras para que cumpram a obrigação de receber refugiados. É um sinal claro de que o Estado passou a cobrar resultado também das autoridades locais.\n\nPara o profissional estrangeiro, o clima mais duro convive com uma porta que segue aberta ao talento qualificado. A via central continua sendo a do Highly Skilled Migrant, restrita a empregadores reconhecidos pela IND, o serviço de imigração holandês, que patrocinam o pedido. O salário mínimo desse visto vem sendo elevado, mantendo um valor reduzido para recém-graduados, e o registro público de sponsors habilitados é o ponto de partida de qualquer plano.\n\nPara empreendedores americanos, o Dutch-American Friendship Treaty permanece como alternativa, com residência mediante investimento no próprio negócio. O conjunto desenha uma Holanda seletiva, que aperta a governança da imigração e recompensa quem chega com oferta formal de emprego ou plano de negócio sólido.", keyFacts: ["Governo colocou os dez primeiros municípios sob supervisão por acolhimento de asilo insuficiente", "Ministro Van den Brink aumentou a pressão sobre as prefeituras para receber refugiados", "Highly Skilled Migrant depende de empregador reconhecido pela IND, com salário mínimo elevado", "DAFT mantém via de residência para empreendedores americanos via investimento", "Autoridades competentes: IND (ind.nl) e governo central via rijksoverheid.nl"], sources: [{ label: "Rijksoverheid · Política de asilo e migração", url: "https://www.rijksoverheid.nl/themas/migratie-en-reizen/asielbeleid" }, { label: "IND, serviço de imigração da Holanda", url: "https://ind.nl/en" }] },
    ],
    blog: [
      { publishedAt: "2026-07-08", headline: "Holanda em modo firme: por que a cobrança aos municípios importa para quem migra", standfirst: "A decisão de colocar os primeiros municípios sob supervisão por acolhimento insuficiente revela um Estado que administra a imigração com rigor, sem por isso fechar a porta ao talento qualificado.", body: "A imagem da Holanda como destino aberto e pragmático convive hoje com uma gestão migratória visivelmente mais dura. No início de julho de 2026, o governo colocou os dez primeiros municípios sob supervisão por não organizarem vagas suficientes de acolhimento para requerentes de asilo. O ministro responsável pela pasta, Van den Brink, subiu o tom com as prefeituras, deixando claro que a obrigação de receber refugiados será cobrada.\n\nÀ primeira vista, o tema parece distante de quem pensa em migrar para trabalhar. Não é. O episódio funciona como termômetro do clima político. Quando o Estado aperta a própria máquina para dar conta do fluxo migratório, o recado que chega ao candidato estrangeiro é de seletividade e de regras aplicadas à risca, do acolhimento ao visto de trabalho.\n\nNo eixo do talento qualificado, a lógica holandesa permanece a mesma, centrada no empregador. Apenas companhias reconhecidas pela IND, o serviço de imigração, podem patrocinar o Highly Skilled Migrant, e o salário mínimo desse visto foi sendo elevado, com um patamar mais baixo para recém-graduados. Para o americano que quer empreender, o Dutch-American Friendship Treaty segue como rota específica de residência por investimento no próprio negócio.\n\nA leitura equilibrada é esta. A Holanda não virou um país fechado, mas deixou de ser um destino em que se entra no improviso. Quem chega com oferta de uma empresa credenciada, salário dentro do patamar exigido ou um plano de negócio sólido encontra um sistema previsível. Quem conta com a sorte esbarra numa governança que, como mostram os municípios sob supervisão, está justamente apertando as pontas soltas. Decidir a partir das fontes oficiais é o que separa o plano viável da frustração.", tags: ["Holanda", "asilo", "trabalho qualificado", "IND", "política migratória"], sources: [{ label: "Rijksoverheid · Política de asilo e migração", url: "https://www.rijksoverheid.nl/themas/migratie-en-reizen/asielbeleid" }, { label: "IND, serviço de imigração da Holanda", url: "https://ind.nl/en" }] },
    ],
  },
  hu: {
    community: [
  ...
  se: {
    community: [
      { publishedAt: "2026-07-08", title: "Suécia avança lei de alívio contra a deportação de quem chegou menor de idade", body: "Em meio a um ciclo migratório dos mais rígidos, o governo sueco avançou no início de julho de 2026 com um projeto de lei de alívio voltado a jovens que chegaram ao país ainda menores de idade e hoje enfrentam a deportação. A medida cria uma exceção pontual dentro de uma política que, no geral, seguiu apertando as regras de permanência.\n\nO tema convive com casos que ganharam repercussão nacional, como o de profissionais em falta no mercado local ameaçados de expulsão por questões administrativas. Para quem acompanha a Suécia, o retrato é de um país que endurece a régua, mas ainda debate onde traçar os limites humanitários.", cta: "Acompanhe a política de migração e os projetos de lei diretamente no portal do governo sueco (regeringen.se) e da agência oficial de migração.", sources: [{ label: "Regeringskansliet · Política de migração e asilo", url: "https://www.regeringen.se/regeringens-politik/migration-och-asyl/" }] },
      { publishedAt: "2026-07-08", title: "💡 Trabalho na Suécia: salário mínimo mais alto e novas regras desde junho", body: "Quem planeja se mudar a trabalho precisa olhar de perto o Migrationsverket, a Agência Sueca de Migração. Novas regras de imigração laboral entraram em vigor em 1º de junho de 2026, e o patamar salarial mínimo exigido para autorizações de trabalho foi elevado, dentro da diretriz de priorizar imigração qualificada e bem remunerada.\n\nAlém disso, novas regras de cidadania passaram a valer desde 6 de junho de 2026. São mudanças recentes que alteram prazos, valores e exigências, e que pedem verificação na fonte oficial antes de qualquer decisão.", cta: "Confira o salário mínimo vigente, a lista de ocupações e as novas regras diretamente no site do Migrationsverket antes de aceitar uma proposta.", sources: [{ label: "Migrationsverket · Swedish Migration Agency", url: "https://www.migrationsverket.se/en.html" }] },
    ],
    countryTab: [
      { publishedAt: "2026-07-08", headline: "Suécia endurece a imigração, mas abre exceção para jovens ameaçados de deportação", standfirst: "O governo avança uma lei de alívio para quem chegou menor de idade, enquanto novas regras de trabalho e cidadania entram em vigor e casos de expulsão de profissionais repercutem.", body: "A política migratória sueca segue em um giro restritivo, e os desdobramentos do início de julho de 2026 confirmam a direção. O governo avançou com um projeto de lei de alívio voltado a jovens que chegaram ao país ainda menores de idade e hoje enfrentam a deportação, uma exceção pontual dentro de um quadro geral de aperto. Ao mesmo tempo, uma campanha oficial para incentivar o retorno voluntário de afegãos não teve adesão, o que expõe a distância entre a meta política e a realidade do terreno.\n\nNo eixo do trabalho, o Migrationsverket, agência oficial de migração, aplica critérios mais duros. Novas regras de imigração laboral entraram em vigor em 1º de junho de 2026, com elevação do salário mínimo exigido para autorizações de trabalho, válido para pedidos iniciais e renovações. Novas regras de cidadania passaram a valer desde 6 de junho de 2026, reforçando o tom seletivo da política.\n\nO contraponto humano apareceu em casos de repercussão nacional, como o de profissionais essenciais ameaçados de expulsão por questões administrativas, mesmo diante da escassez de mão de obra em cidades do norte. O cenário sueco, portanto, combina rigor crescente com debates abertos sobre onde ficam os limites. Qualquer planejamento deve partir das regras atualizadas da própria agência.", keyFacts: ["Governo avança lei de alívio para jovens que chegaram menores de idade e enfrentam deportação", "Campanha oficial de retorno voluntário de afegãos não teve adesão", "Novas regras de imigração laboral em vigor desde 1º de junho de 2026, com salário mínimo elevado", "Novas regras de cidadania em vigor desde 6 de junho de 2026", "Autoridade competente: Migrationsverket, a Agência Sueca de Migração (migrationsverket.se)"], sources: [{ label: "Migrationsverket · Swedish Migration Agency", url: "https://www.migrationsverket.se/en.html" }, { label: "Regeringskansliet · Política de migração e asilo", url: "https://www.regeringen.se/regeringens-politik/migration-och-asyl/" }] },
    ],
    blog: [
      { publishedAt: "2026-07-08", headline: "Suécia entre o rigor e a exceção: o que muda para quem quer trabalhar e ficar", standfirst: "Novas regras de trabalho e cidadania convivem com uma lei de alívio para jovens ameaçados de deportação e com casos de expulsão de profissionais essenciais. O retrato é de um país seletivo, ainda em disputa sobre seus próprios limites.", body: "A Suécia consolidou nos últimos anos uma virada restritiva na imigração, e os fatos do início de julho de 2026 ajudam a entender até onde essa régua vai. De um lado, o governo avançou com um projeto de lei de alívio para jovens que chegaram ao país ainda menores de idade e hoje enfrentam a deportação. De outro, uma campanha oficial para persuadir afegãos a voltar para casa não conseguiu nenhum adepto, sinal de que a política de retorno esbarra na resistência de quem já construiu vida no país.\n\nPara o profissional estrangeiro, o que pesa no dia a dia são as regras de trabalho. Desde 1º de junho de 2026 vigoram novas normas de imigração laboral, com o salário mínimo exigido para autorizações elevado, tanto para pedidos iniciais quanto para renovações. A orientação é clara, priorizar quem chega com qualificação e remuneração altas. Em paralelo, novas regras de cidadania passaram a valer desde 6 de junho de 2026, o que reforça o filtro para quem sonha com o passaporte sueco no longo prazo.\n\nO ponto mais delicado dessa equação apareceu em casos concretos. Profissionais considerados essenciais em cidades do norte, onde a falta de mão de obra é aguda, viram-se ameaçados de expulsão por detalhes administrativos. É o velho paradoxo da imigração sueca, um sistema que precisa de gente qualificada, mas cuja rigidez às vezes empurra para fora exatamente quem o mercado pede.\n\nA leitura para quem planeja a Suécia é de cautela informada. O país continua atraente pela qualidade de vida e pelo mercado de trabalho, mas deixou pouca margem para improviso. Salário dentro do novo patamar, documentação impecável e acompanhamento das regras atualizadas do Migrationsverket são hoje o mínimo para transformar o plano em residência estável. Decidir pela fonte oficial, e não por relatos de terceiros, é o que reduz o risco de virar mais um caso de expulsão evitável.", tags: ["Suécia", "trabalho", "cidadania", "deportação", "Migrationsverket"], sources: [{ label: "Migrationsverket · Swedish Migration Agency", url: "https://www.migrationsverket.se/en.html" }, { label: "Regeringskansliet · Política de migração e asilo", url: "https://www.regeringen.se/regeringens-politik/migration-och-asyl/" }] },
    ],
  },
  cz: {
    community: [
