...
export const EDITORIAL: Record<string, CountryEditorial> = {
  ...
  es: {
    community: [
      { title: "Espanha amplia o reagrupamento familiar", body: "A Espanha mantém uma política migratória estável, com atenção especial ao reagrupamento familiar e à regularização de quem já vive no país há tempo. O Arraigo Familiar, uma das vias de enraizamento, ampliou critérios e passou a aceitar comprovação por meios digitais.\n\nA gestão dos pedidos é feita pela Extranjería, com boa parte dos trâmites disponível na sede eletrônica das administrações públicas. Entender qual modalidade de arraigo se aplica ao seu caso é o primeiro passo, já que cada uma tem requisitos próprios de tempo de permanência e vínculos.", cta: "Use a sede eletrônica oficial das administrações públicas para agendar cita previa e acompanhar o andamento do processo, reunindo provas de vínculo familiar e residência com antecedência.", sources: [{ label: "Extranjería · Sede Electrónica de las Administraciones Públicas", url: "https://sede.administracionespublicas.gob.es/procedimientos/index/categoria/34" }] },
    ...
    countryTab: [
      { headline: "Espanha aposta na estabilidade e no reagrupamento familiar", standfirst: "Arraigo Familiar amplia critérios e aceita comprovação digital, num cenário migratório sem grandes sobressaltos.", body: "A Espanha segue um rumo migratório estável, com ênfase no reagrupamento familiar e na regularização de residentes de longa data. A Extranjería, responsável pelos pedidos, vem digitalizando trâmites na sede eletrônica das administrações públicas.\n\nO Arraigo Familiar ampliou seus critérios e passou a aceitar comprovação por meios digitais, simplificando o caminho de quem busca reunir a família no país. É uma das várias figuras de arraigo, mecanismos que permitem regularizar quem já tem vínculos consolidados na Espanha.\n\nPara quem planeja se estabelecer, conhecer as modalidades de arraigo e seus requisitos é essencial. Cada uma exige provas específicas de tempo de permanência, laços familiares ou inserção social, e a organização da documentação costuma ser decisiva.", keyFacts: ["Autoridade competente: Extranjería, via sede eletrônica das administrações públicas", "Arraigo Familiar com critérios ampliados e comprovação digital", "Foco em reagrupamento familiar e regularização de longa data"], sources: [{ label: "Extranjería · Sede Electrónica de las Administraciones Públicas", url: "https://sede.administracionespublicas.gob.es/procedimientos/index/categoria/34" }] },
    ],
    blog: [],
  },
  de: {
  ...
  it: {
    community: [
      { title: "Itália abre milhares de vagas no Decreto Flussi", body: "A Itália anunciou o Decreto Flussi de 2026, que define cotas anuais para a entrada de trabalhadores estrangeiros. São muitas vagas previstas, com distribuição preferencial para alguns países da América do Sul, o que costuma gerar forte procura assim que a janela de registro abre.\n\nO Decreto Flussi funciona por janelas específicas de inscrição, então a preparação antecipada é tudo. Quem deixa a documentação pronta antes da abertura tem vantagem real, já que a demanda tende a esgotar as cotas rapidamente. As informações oficiais de visto ficam no portal Visto per l'Italia.", cta: "Acompanhe as datas e cotas do Decreto Flussi nos canais oficiais e tenha a documentação pronta antes da janela abrir, conferindo os requisitos no portal vistoperitalia.esteri.it.", sources: [{ label: "Visto per l'Italia · Ministério dos Negócios Estrangeiros", url: "https://vistoperitalia.esteri.it/" }] },
    ...
    countryTab: [
      { headline: "Itália anuncia novo Decreto Flussi com cotas para 2026", standfirst: "Milhares de vagas previstas e distribuição preferencial a países sul-americanos prometem alta demanda na janela de registro.", body: "A Itália voltou a movimentar o cenário migratório com o Decreto Flussi de 2026, mecanismo que estabelece cotas anuais para trabalhadores estrangeiros. A previsão é de muitas vagas, com distribuição preferencial a alguns países da América do Sul, o que costuma atrair candidatos brasileiros.\n\nO sistema opera por janelas de registro com data marcada, e a concorrência é intensa. Por isso, a preparação antecipada faz diferença: ter documentos organizados antes da abertura aumenta as chances diante de cotas que se esgotam rápido. A autoridade MAECI, o Ministério dos Negócios Estrangeiros, conduz a política de vistos.\n\nA contrapartida da alta procura é o aumento de golpes. As autoridades já alertaram para sites que clonam o portal oficial, reforçando a importância de usar apenas os canais reconhecidos e de digitar o endereço manualmente ao buscar informação.", keyFacts: ["Autoridade competente: MAECI, Ministério dos Negócios Estrangeiros", "Decreto Flussi 2026 com cotas e janela de registro definida", "Atenção a sites falsos: use apenas vistoperitalia.esteri.it"], sources: [{ label: "Visto per l'Italia · Ministério dos Negócios Estrangeiros", url: "https://vistoperitalia.esteri.it/" }] },
    ],
    blog: [],
  },
  dk: {
  ...
  ro: {
    community: [
      { title: "Romênia no Schengen muda o jogo para quem quer morar na Europa", body: "A entrada da Romênia no espaço Schengen, concretizada em 2024, ampliou de forma concreta o interesse de quem busca um ponto de partida acessível na União Europeia. Com a livre circulação consolidada, viver no país passou a significar também trânsito mais simples por boa parte do continente.\n\nA combinação de custo de vida competitivo e um setor de tecnologia em expansão, com polos relevantes em Bucareste e Cluj, reforça esse movimento. Para muita gente, a Romênia deixou de ser coadjuvante e virou alternativa real frente a destinos europeus mais caros.", cta: "Verifique sempre as regras de residência diretamente no portal da Inspetoria Geral para Imigração, a autoridade oficial do país, antes de iniciar qualquer pedido.", sources: [{ label: "IGI · Inspectoratul General pentru Imigrări", url: "https://igi.mai.gov.ro/" }] },
      { title: "💡 O Digital Nomad Visa romeno e a regra dos 183 dias", body: "A Romênia estruturou um visto de nômade digital voltado a profissionais de fora da União Europeia que trabalham para empresas ou clientes no exterior. A autorização tem validade inicial de doze meses e pode ser renovada, exigindo comprovação de renda recorrente vinda de fora do país, além de seguro saúde e endereço local.\n\nUm ponto que costuma gerar dúvida é o tratamento fiscal. A permanência prolongada pode mudar a forma como sua renda é tratada no país, então entender o limite de tempo que define residência fiscal é parte essencial do planejamento.", cta: "Antes de estender a estadia, calcule com cuidado quantos dias pretende permanecer no país e avalie o impacto fiscal com um profissional licenciado.", sources: [{ label: "IGI · Inspectoratul General pentru Imigrări", url: "https://igi.mai.gov.ro/" }] },
    ],
    countryTab: [
      { headline: "Romênia se firma como porta de entrada barata na União Europeia", standfirst: "Schengen, custo de vida baixo e um polo tech crescente atraem novos residentes.", body: "Desde que ingressou no espaço Schengen, em 2024, a Romênia viu crescer o fluxo de pessoas interessadas em usar o país como base na Europa. A livre circulação tornou o destino mais atraente para quem quer viver dentro da União Europeia sem os custos elevados de outras capitais.\n\nO Digital Nomad Visa é uma das vias mais comentadas. Pensado para profissionais de fora do bloco que mantêm renda no exterior, oferece autorização inicial de doze meses, renovável, mediante comprovação de rendimentos, seguro saúde e moradia no país.\n\nO crescimento do setor de tecnologia, com clusters em Bucareste e Cluj, completa o quadro. Ainda assim, regras de renda e tratamento fiscal mudam conforme a situação de cada pessoa, e a consulta à fonte oficial evita surpresas.", keyFacts: ["Romênia entrou no espaço Schengen em 2024, ampliando a livre circulação", "Digital Nomad Visa tem validade inicial de 12 meses, renovável", "Polos de tecnologia em Bucareste e Cluj impulsionam a demanda"], sources: [{ label: "IGI · Inspectoratul General pentru Imigrări", url: "https://igi.mai.gov.ro/" }] },
    ],
    blog: [],
  },
  se: {
