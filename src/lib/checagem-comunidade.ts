...
},
{
  ...
  fontesCitadas: [
    ...
    { nome: "Home Office · Statement of changes HC 259, versão acessível (GOV.UK)", url: "https://www.gov.uk/government/publications/statement-of-changes-to-the-immigration-rules-hc-259-9-july-2026/statement-of-changes-to-the-immigration-rules-hc-259-9-july-2026-accessible", oficial: true },
    { nome: "Home Office · Explanatory Memorandum ao HC 259, versão acessível (GOV.UK)", url: "https://www.gov.uk/government/publications/statement-of-changes-to-the-immigration-rules-hc-259-9-july-2026/explanatory-memorandum-to-the-statement-of-changes-in-immigration-rules-hc-259-9-july-2026-accessible", oficial: true },
  ],
  nota: "FATO confirmado no texto oficial e no memorando explicativo (GOV.UK): o HC 259 foi apresentado ao Parlamento em 09/07/2026, com vigência em 30/07/2026 (Appendix EU e EU Family Permit) e 03/08/2026 (demais mudanças). Alcança mais de 30 Appendices e Partes, entre eles a Graduate route (filhos nascidos no Reino Unido), o Appendix FM (prazo da permissão do parceiro alinhado ao do patrocinador com proteção), a Parte 8 (crianças que se juntam a familiares, paras. 297 e 298, alinhada ao Appendix Child Relative), a Parte Suitability (estar em fiança migratória deixa de ser motivo único de recusa de quem se enquadra na exceção SUI13.1 para overstayers), a Parte 11 (para. 339NA, novas hipóteses de dispensa de entrevista de asilo sob o modelo de registro unificado), a Parte 13 (deportação alinhada ao Sentencing Act 2026) e o Child Student route. Revisão de 20/07/2026: as três alegações das peças publicadas foram conferidas uma a uma no documento oficial e todas CONFIRMADAS. (1) Parte 8, o Statement traz a seção 'Changes to Part 8' com as mudanças 8.1 a 8.6 alterando os paras. 297(i)(f), 297(i)(g) novo, 298(i)(d), 298(i)(e) novo, 319C(h)(iv) e 319H(h)(iv), e o memorando traz 'Part 8: Changes to provisions for children' (§5.9 a §5.12). (2) Fiança migratória, memorando §5.16, sob 'Changes to Part Suitability requirements', garante que o pedido de quem se enquadra na Exception for Overstayers (SUI13.1) não seja recusado apenas por a pessoa estar em immigration bail, fórmula repetida na Parte 8 (8.5 e 8.6) e em mais de 30 Appendices. Precisão registrada: o HC 259 não cria uma exceção de fiança, ele impede que a exceção já existente para overstayers seja anulada pelo fato de a pessoa estar em fiança. (3) Entrevista de asilo, memorando §5.22 a §5.27 ('Asylum Interviews: Additional circumstances when interviews may be omitted'), com o modelo de 'merged registration' de entrevista única (§5.24), e o Statement altera o para. 339NA na seção 'Changes to Part 11', inserindo os novos 339NA(ix) e (x) sobre nacionais do EEE e da Suíça e sobre a discricionariedade do Secretary of State em pedidos claramente infundados (§5.27). As datas de vigência citadas nas peças, 30 de julho e 3 de agosto de 2026, batem com o oficial. Nenhuma alegação ficou pendente ou refutada.",
  curadoEm: "2026-07-20",
  countryCode: "uk",
},
{
